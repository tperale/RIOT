...
#define SX128X_RSSI_OFFSET (-139)
#else /* MODULE_SX1276 */
#define SX128X_RSSI_OFFSET_LF (-164)
#define SX128X_RSSI_OFFSET_HF (-157)
#endif
/** @} */
 ...
 */
#if defined(MODULE_SX1272)
#define SX128X_POR_ACTIVE_LOGIC_LEVEL (1)
#else /* MODULE_SX1276 */
#define SX128X_POR_ACTIVE_LOGIC_LEVEL (0)
#endif
/** @} */
